    ...
    <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5">
            ...
            <form action="<?php echo URLROOT; ?>/users/register" method="POST">
                ...
                <div class="row">
                    <div class="col">
                        <input type="submit" value="Register" class="btn btn-success btn-black">
                    </div>
                    <div class="col">
                        <a href="<?php echo URLROOT; ?>/users/login" class="btn btn-white btn-block">Have an account? Login</a>
                    </div>
                </div>
            </form>
        </div>
